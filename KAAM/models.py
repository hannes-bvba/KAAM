...
class CompetenceTeam(ownedObject):
    Name = models.CharField("Name", max_length=30)
    company = models.ForeignKey(Company,verbose_name="The company to which this team belongs")
    TeamLead = models.ForeignKey(User, verbose_name= "The Teamlead of this team")
...
class TeamMember(User):
    competenceTeam = models.ForeignKey(CompetenceTeam,verbose_name="The competence team to which this user belongs")
...
class Skill(models.Model):
    ...
    Name = models.CharField("Name", max_length=30)
    company = models.ForeignKey(Company,verbose_name="The company to which this skill belongs")
...
#    Name = models.CharField("Name", max_length=30)
    skill = models.ForeignKey(Skill,verbose_name="Skill/Affinity")
    teamMember = models.ForeignKey(TeamMember,verbose_name="Team member")
...
class Skill_CT(models.Model):
    Name = models.CharField("Name", max_length=30)
    skill = models.ForeignKey(Skill,verbose_name="Skill/Affinity")
    competenceTeam = models.ForeignKey(CompetenceTeam, verbose_name='The competence team to which this skill belongs')
